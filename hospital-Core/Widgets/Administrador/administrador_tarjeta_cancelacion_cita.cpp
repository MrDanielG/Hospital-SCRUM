...
administrador_tarjeta_cancelacion_cita::administrador_tarjeta_cancelacion_cita(QString nombre, QString paterno, QString materno, QString motivo, QString hInicio, QString hFin, QString foto, QWidget *parent) :
    QWidget(parent),
